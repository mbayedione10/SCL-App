...
class resiliation(models.Model):
    ...
    tva = models.IntegerField(null=False, default=0)
    timbre = models.IntegerField(default=0, null=True)
    montant_ttc = models.IntegerField(null=False, default=0)
    montant_a_payer = models.IntegerField(null=False, default=0)
...
class affaire(models.Model):
    ...
    montant = models.IntegerField(null=True, default=0)
    user = models.ManyToManyField(User)
    date_ajout = models.DateTimeField(auto_now_add=True)
