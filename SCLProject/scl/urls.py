...
urlpatterns = [
    ...
    path('manuel/dashboard', SearchManuelDashboard.as_view(), name='manuelDashboard'),
    ...
    path('resiliation/dashboard/', SearchResiliationDashboard.as_view(), name='resiliationDashboard' ),
    ...
    path('affaire/dashboard', SearchAffaireDashboard.as_view(), name='affaireDashboard'),
